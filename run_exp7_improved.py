...
# Remanentia — Experiment 7: Improved pipeline
...
for ci, conv in enumerate(ds):
    ...
    if (ci + 1) % 5 == 0:
        ...
        Path("exp7_progress.txt").write_text(
...
out = {
    "experiment": "Full pipeline v2: +entity boost+typed prompts",
...
Path("exp7_results.json").write_text(json.dumps(out, indent=2))
