...
def _type_prompt(question: str, qtype: str, context: str) -> str:
    ...
    if qtype == "multi-session":
        return (
            ...
            "If the context contains a 'COMPUTED TOTAL:' line, trust it unless "
            "it clearly contradicts the question — the arithmetic has been "
            "double-checked by deterministic code.\n"
