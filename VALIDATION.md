...
|-----------|---------|--------|------:|-------|
| LongMemEval full-S | realistic | cloud gpt-4o-mini | **56.9 %** (band 56.8–57.0) | **headline-eligible** two-seed run (42: 56.8 %, 1337: 57.0 %; stdev 0.14), full judge evidence per row (judge gpt-4o-mini), reader stamped per row; manifest `longmemeval/full_s/gpt-4o-mini` eligible. Consistent with the earlier 3-run mean 56.6 % (spread 2.2) |
